  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] flex flex-col p-0 gap-0">
        ...
        {/* Horizontal stepper */}
        <div className="px-6 my-4 border-b pb-4">
                ...
                <li key={step.id} className="md:flex-1">
                  <button
                    ...
                    className={cn(
                      ...
                      currentStep === index
                        ...
                        : currentStep > index
                          ? "border-primary/50 text-primary/80 hover:border-primary/70"
                  ...
                  >
                    <span className="flex items-center text-sm font-medium">
                      <span
                        className={cn(
                          "flex h-7 w-7 items-center justify-center rounded-full border text-xs font-medium mr-2",
                          currentStep === index
                            ? "border-primary bg-primary text-primary-foreground"
                            : currentStep > index
                              ? "border-primary/50 bg-primary/10 text-primary group-hover:border-primary/70"
